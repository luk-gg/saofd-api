    ...
    Characters
        ...
        .map(async ({ id, seasonFolder }) => {
            ...
            const seasonIconMap = {
                ...
                "UCR032": "Season2", // M
                "UCR033": "Season3", // Philia
                "UCR034": "Season3", // Sachi
                "UCR035": "Season4", // Cat Knight Alice
                "UCR036": "Season4", // Mito
            }
            const icon = `/Content/${seasonIconMap[id] || "Product"}/UI/Texture/HUD/hud_switchchain/cut_in_chara/hud_switchchain_cutin_${id.substring(3)}.png`;
