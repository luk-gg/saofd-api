...
export default Object.entries(ClothData)
    .map(([id, item]) => {
        ...
        const sources = [...getDropSources(null, "ESGItemType::ClothSkin", Number(id.slice(3))), ...getCharacterRankSources(id), ...getSerialCodeSources(id), ...getDefaultUnlockedSources(id)]
